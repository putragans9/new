...
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: '🌹COMMAND' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: '👥OWNER BOT' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: '🍀SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr,pemilik]}}}, 'buttonsMessage')
...
reply(`${err}`)
	...
	Dhani.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Riko Ganz",body:"Jangan Lupa Follow Ig riko_store31",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dhani.jpg'),sourceUrl:"https://wa.me/6281333603591"}}})
        }
	// console.log(e)
	}
}
